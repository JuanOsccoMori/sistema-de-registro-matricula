...
public class ReporteAlumnoConMatriculaPendiente extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			...
			ReporteAlumnoConMatriculaPendiente dialog = new ReporteAlumnoConMatriculaPendiente();
	 ...
	 * Create the dialog.
	 */
	public ReporteAlumnoConMatriculaPendiente() {
		setTitle("Reporte de Alumno Con Matricula Pendiente");
